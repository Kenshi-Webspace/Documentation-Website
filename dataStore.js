...
`
    },
    {
        ...
        content: `<p>Vercel configuration file exists. When deploying to Vercel, add environment variables in project settings. For local tunnels use the provided <code>tunnel/ngrok</code> scripts (if implemented).</p>
<ul>
